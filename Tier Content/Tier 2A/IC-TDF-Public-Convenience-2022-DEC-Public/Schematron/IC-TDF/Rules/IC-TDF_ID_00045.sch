...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [IC-TDF-ID-00045][Error] Regardless of the version indicated on the instance document, 
        the validation infrastructure MUST use a version of 'RevRecall' that is version '202111' (Version:2021-NOV) 
    ...
    <sch:param name="RuleID" value="'IC-TDF-ID-00045'"/>
</sch:pattern>