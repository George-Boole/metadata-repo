<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="IC-TDF-ID-00046" is-a="CompareVersionsInSkeleton">
    <sch:p class="ruleText">
        [IC-TDF-ID-00046][Error] If there exist multiple version attributes in the 
        same namespace within the TDF skeleton, then they must specify the same version number.
        
        Human Readable: The ism:DESVersion declared for a specification must be the same throughout the IC-TDF
    ...
    <sch:param name="context" value="//tdf:*[@ism:DESVersion]                                      | //tdf:HandlingAssertion//*[@ism:DESVersion]                                      | //tdf:StatementMetdata//*[@ism:DESVersion]"/>
    <sch:param name="namespace" value="'urn:us:gov:ic:ism'"/>
    <sch:param name="attrName" value="'DESVersion'"/>
    <sch:param name="ruleID" value="'IC-TDF-ID-00046'"/>
</sch:pattern>