<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00338" is-a="ValidateTokenValuesExistenceInList">
    <sch:p class="ruleText">
        [ISM-ID-00338][Error] All @ism:compliesWith values must
    ...
    <sch:param name="errMsg" value="'         [ISM-ID-00338][Error] All @ism:compliesWith values must         be defined in CVEnumISMCompliesWith.xml.         '"/>
</sch:pattern>