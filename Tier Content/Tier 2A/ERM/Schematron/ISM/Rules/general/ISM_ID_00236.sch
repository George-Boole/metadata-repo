<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText"> [ISM-ID-00236][Error] Duplicate tokens are not permitted in ISM
        attributes.</sch:p>

    <sch:p class="codeDesc"> To determine the valid values, this rule first retrieves the CVE values
    ...
    <sch:rule id="ISM-ID-00236-R1" context="*[@ism:*]">
        ...
        <sch:assert test="not($hasDups)" flag="error" role="error"> [ISM-ID-00236][Error] Duplicate tokens are
            not permitted in ISM attributes. Duplicate values found: [<sch:value-of select="$dupValues"/>]</sch:assert>
    </sch:rule>
</sch:pattern>