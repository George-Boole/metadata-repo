<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
	  ...
	  <sch:rule id="ISM-ID-00358-R1" context="*[@ism:resourceElement=true()][1]">
	  	...
	  	<sch:let name="tetrasWithReleasableTo" value="distinct-values(for $value in $tetras return        if($catt//catt:Tetragraph[catt:TetraToken=$value]/@ism:releasableTo)         then $value        else null)"/>
