<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
	...
	<sch:param name="searchTermList" value="normalize-space(string(./@ism:ownerProducer))"/>
	<sch:param name="list" value="tokenize(normalize-space(string(@ism:releasableTo)), ' ')"/>
