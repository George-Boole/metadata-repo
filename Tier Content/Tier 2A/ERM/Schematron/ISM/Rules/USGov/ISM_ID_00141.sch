<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText"> [ISM-ID-00141][Error] If ISM_NSI_EO_APPLIES and:
        ...
        50X1-HUM, 50X2-WMD, AEA, NATO, or NATO-AEA is specified. </sch:p>
    
    <sch:p class="codeDesc"> If ISM_NSI_EO_APPLIES, the current element is the ISM_RESOURCE_ELEMENT,
    ...
    <sch:rule id="ISM-ID-00141-R1" context="             *[$ISM_NSI_EO_APPLIES and generate-id(.) = generate-id($ISM_RESOURCE_ELEMENT) and             not(util:containsAnyOfTheTokens(@ism:declassException, ('25X1-EO-12951', '50X1-HUM', '50X2-WMD', 'AEA', 'NATO', 'NATO-AEA')))]">
        <sch:assert test="@ism:declassDate or @ism:declassEvent" flag="error" role="error"> [ISM-ID-00141][Error]
            Documents under E.O. 13526 require declassDate or declassEvent unless 25X1-EO-12951,
            50X1-HUM, 50X2-WMD, AEA, NATO, or NATO-AEA is specified.</sch:assert>
    </sch:rule>
