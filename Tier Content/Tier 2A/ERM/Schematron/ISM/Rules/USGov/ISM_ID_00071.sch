<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00071" is-a="AttributeContributesToRollup">
    <sch:p class="ruleText">
        [ISM-ID-00071][Error] If ISM_USGOV_RESOURCE and any element meeting ISM_CONTRIBUTES 
