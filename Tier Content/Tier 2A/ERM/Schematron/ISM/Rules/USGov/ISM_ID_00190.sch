<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00190" is-a="AttributeValueDeprecatedWarning">
    ...
    <sch:p class="codeDesc">
    	...
    	this rule ensures that the value of ism:FGIsourceProtected has not been 
	  ...
	  <sch:param name="cveName" value="CVEnumISMCATFGIProtected"/>
