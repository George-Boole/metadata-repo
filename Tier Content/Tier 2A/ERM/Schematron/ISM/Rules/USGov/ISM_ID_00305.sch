<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00305">
  ...
  <sch:rule id="ISM-ID-00305-R1" context="*[$ISM_USGOV_RESOURCE     and util:containsAnyOfTheTokens(@ism:SCIcontrols, ('TK-IDIT'))]">
