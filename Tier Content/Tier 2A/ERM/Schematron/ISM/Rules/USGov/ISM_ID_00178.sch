<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00178" is-a="ValuesOrderedAccordingToCve">
  ...
  <sch:param name="errorMessage" value="'     [ISM-ID-00178][Error] If ISM_USGOV_RESOURCE and attribute      atomicEnergyMarkings is specified, then each of its values must be ordered in accordance with      CVEnumISMAtomicEnergyMarkings.xml.     '"/>
</sch:pattern>