<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00259" is-a="ValidateTokenValuesExistenceInList">
    <sch:p class="ruleText">
    	[ISM-ID-00259][Error] All @ism:FGIsourceOpen values must
    	be defined in CVEnumISMCATFGIOpen.xml.
    </sch:p>
	  ...
	  <sch:param name="errMsg" value="'   [ISM-ID-00259][Error] All @ism:FGIsourceOpen values must   be defined in CVEnumISMCATFGIOpen.xml.   '"/>
</sch:pattern>