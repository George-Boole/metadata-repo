<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText">
        ...
        1. No element meeting ISM_CONTRIBUTES in the document has the attribute nonICmarkings containing [SSI]
        AND
        2. Any element meeting ISM_CONTRIBUTES in the document has the attribute noticeType containing [SSI]
