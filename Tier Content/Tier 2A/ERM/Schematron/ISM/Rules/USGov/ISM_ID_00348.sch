<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="codeDesc">If ISM_USGOV_RESOURCE and attribute @ism:SARIdentifier of
        ...
        @ism:SARIdentifier with each value specified on the ISM_RESOURCE_ELEMENT. </sch:p>
