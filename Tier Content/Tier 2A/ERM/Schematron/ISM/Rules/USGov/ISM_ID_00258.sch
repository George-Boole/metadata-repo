<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00258" is-a="ValidateTokenValuesExistenceInList">
    <sch:p class="ruleText">
	  ...
	  <sch:param name="errMsg" value="'   [ISM-ID-00258][Error] All @ism:disseminationControls values must   be a defined in CVEnumISMDissem.xml.   '"/>
</sch:pattern>