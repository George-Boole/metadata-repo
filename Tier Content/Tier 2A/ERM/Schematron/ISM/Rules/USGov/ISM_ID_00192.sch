<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00192" is-a="AttributeValueDeprecatedWarning">
    ...
    <sch:p class="codeDesc">
    	...
    	this rule ensures that the value of ism:nonICmarkings has not been 
