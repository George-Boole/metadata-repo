<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:rule id="ISM-ID-00341-R1" context="*[$ISM_USGOV_RESOURCE and (util:containsAnyTokenMatching(@ism:SCIcontrols, ('^SI-G-[A-Z]{4}$'))) or util:containsAnyOfTheTokens(@ism:SCIcontrols, ('SI-G'))]">
        ...
        <sch:assert test="not(util:containsAnyOfTheTokens(@ism:disseminationControls, ('OC-USGOV')))" flag="error" role="error"> [ISM-ID-00341][Error] If ISM_USGOV_RESOURCE and SCIcontrols contains a token matching [SI-G] or
