<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00296">
	  ...
	  <sch:rule id="ISM-ID-00296-R1" context="*[@ism:SCIcontrols]">
		    <sch:assert test="util:meetsType(@ism:SCIcontrols, $NmTokensPattern)" flag="error" role="error">
