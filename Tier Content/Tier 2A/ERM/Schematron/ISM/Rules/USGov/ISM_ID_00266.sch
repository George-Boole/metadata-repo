<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00266" is-a="ValidateTokenValuesExistenceInListWhenContributesToRollup">
    <sch:p class="ruleText">
    	[ISM-ID-00266][Error] Any @ism:SARIdentifier values that contributes to rollup must
    	be defined in CVEnumISMSAR.xml.
    </sch:p>
	  ...
	  <sch:param name="errMsg" value="'[ISM-ID-00266][Error] All @ism:SARIdentifier values must be defined in CVEnumISMSAR.xml.'"/>
</sch:pattern>