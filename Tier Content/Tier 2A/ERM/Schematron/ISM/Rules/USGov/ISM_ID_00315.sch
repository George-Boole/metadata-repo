<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText"> [ISM-ID-00315][Error] If classified element meets ISM_CONTRIBUTES and
        ...
        roll-up and has NATO Information must also specify a NATO declass exemption on the banner. </sch:p>
    <sch:p class="codeDesc"> In a classified document that meets ISM_USGOV_RESOURCE, for each
        ...
        the token [NATO] or [NATO-AEA]. </sch:p>
    <sch:rule id="ISM-ID-00315-R1" context="             *[not(generate-id(.) = generate-id($ISM_RESOURCE_ELEMENT))             and util:contributesToRollup(.)             and $ISM_USGOV_RESOURCE             and not(@ism:classification = 'U')             and util:containsAnyTokenMatching(@ism:ownerProducer, ('NATO:?'))]">
        <sch:assert test="util:containsAnyOfTheTokens($ISM_RESOURCE_ELEMENT/@ism:declassException, ('NATO', 'NATO-AEA'))" flag="error" role="error"> [ISM-ID-00315][Error] If element meets ISM_CONTRIBUTES and attribute
