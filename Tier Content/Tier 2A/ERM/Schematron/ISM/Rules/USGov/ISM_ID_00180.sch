<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00180" is-a="AttributeValueDeprecatedError">
    ...
    <sch:p class="codeDesc">
    	...
    	this rule ensures that the value of ism:disseminationControls has not been 
