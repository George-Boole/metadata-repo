<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
       ...
       --><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00291">
	  ...
	  <sch:rule id="ISM-ID-00291-R1" context="*[@ism:ownerProducer]">
		    <sch:assert test="util:meetsType(@ism:ownerProducer, $NmTokensPattern)" flag="error" role="error">
