<?xml version="1.0" encoding="UTF-8"?><?ICEA pattern?><!-- Notices - Distribution Notice: 
    ...
    <sch:p class="ruleText">
	  ...
	  <sch:p class="codeDesc">
		...
		Classified USA documents containing a non-external DS notice must also have DS data however that is not currently testable since classified documents do not have to have DS at the document level.
	</sch:p>
