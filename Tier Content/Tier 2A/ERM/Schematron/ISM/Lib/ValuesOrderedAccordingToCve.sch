<?xml version="1.0" encoding="UTF-8"?><sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" abstract="true" id="ValuesOrderedAccordingToCve">
  <sch:p class="codeDesc">To perform sorting, each attribute token
  ...
  <sch:rule id="ValuesOrderedAccordingToCve-R1" context="*[$ISM_USGOV_RESOURCE and @ism:$attrLocalName]">
