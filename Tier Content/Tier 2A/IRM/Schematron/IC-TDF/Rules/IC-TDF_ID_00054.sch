...
<!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="IC-TDF-ID-00054">
    ...
    <sch:rule id="IC-TDF-ID-00054-R1" context="*[@tdf:version]">
        <sch:assert test="matches(@tdf:version, '^202111-IC-TDF.202111(\-.{1,23})?$')" flag="warning" role="warning">
            [IC-TDF-ID-00054][Warning] tdf:version attribute SHOULD be specified as
            version 202111-IC-TDF.202111 with an optional extension. Found: <sch:value-of select="@tdf:version"/>
        </sch:assert>
    </sch:rule>
</sch:pattern>
